...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-avatar" '("jabber-" "avatar")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-conn" '("jabber-" "*jabber-virtual-server-function*")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-ourversion" '("jabber-version")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-rtt" '("jabber-rtt-")))
