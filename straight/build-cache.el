...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2018-09-09 15:10:11+0300" nil (:local-repo nil :package "org-elpa" :type git)) "straight" ("2018-09-09 15:10:11+0300" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-plus-contrib" ("2018-08-18 13:09:50+0300" nil (:type git :repo "https://code.orgmode.org/bzg/org-mode.git" :local-repo "org" :files (:defaults "contrib/lisp/*.el") :package "org-plus-contrib")) "move-lines" ("2018-09-09 15:10:12+0300" nil (:type git :host github :repo "targzeta/move-lines" :package "move-lines" :local-repo "move-lines")) "point-im" ("2018-09-09 15:10:13+0300" ("emacs" "jabber") (:host github :repo "rayslava/emacs-point-el" :package "point-im" :type git :local-repo "emacs-point-el")) "melpa" ("2018-09-09 15:10:11+0300" nil (:type git :host github :repo "melpa/melpa" :no-build t :package "melpa" :local-repo "melpa")) "jabber" ("2018-09-09 15:10:13+0300" nil (:type git :files ("*.el" "*.texi" ("jabber-fallback-lib" "jabber-fallback-lib/hexrgb.el")) :repo "https://github.com/legoscia/emacs-jabber.git" :package "jabber" :local-repo "emacs-jabber"))))
